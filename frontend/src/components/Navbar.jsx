...
export default function Navbar(props) {
  ...
  return (
    <>
    <div className='z-50 text-black h-[80px] backdrop-blur-sm text-bold flex justify-between w-full backdrop-grayscale-[100%]'> 
        <div className='ml-[30px] flex flex-col justify-center cursor-pointer' onClick={()=>(setSidebar(!sidebar))}> {/*LEFT NAVBAR */}
    ...
    <ul className='nav-menu-items flex flex-col justify-between' onClick={()=>(setSidebar(!sidebar))}>
      ...
      <li  className='menu-bars cursor-pointer mb-[20px]' onClick={()=>{logout()}}>
