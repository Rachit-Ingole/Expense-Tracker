...
export default function Auth(props) {
    ...
    function handleRegister(e) {
        ...
        async function register() {
            try {
                ...
                const {data: actualData} = await axios.post(API_URL, {
                    "username": username,
                    "email_address": email,
                    "password": password
                })
    ...
    return (
        page == "home" ?
            <div className='w-screen h-screen bg-slate-800 text-white '>
                ...
                <div className=' flex h-[600px] w-[85%] m-auto'>
                    <div className='flex flex-col lg:w-1/2 justify-center gap-[20px]'>
                        <h1 className='text-4xl font-Mont  font-semibold'>Expense <span
                            className='text-blue-300'>Tracking</span> App</h1>
                        <p className='text-lg font-Poppins'>Welcome</p>
                        <button onClick={(e) => setPage("login")}
                                className='w-[200px] cursor-pointer font-Poppins bg-blue-400 pt-2 pb-2 pl-1 pr-1 rounded-lg font-semibold'>
                            Login/Register
                        </button>
                    </div>
            ...
            :
            (page == "login" ?
                    <div className='w-screen h-screen bg-slate-800 text-white flex justify-center ' onKeyDown={(e) => {
                        if (e.key == "Enter") {
                            handleLogin(e)
                        }
                    }}>
                        <div className='auth-page flex w-screen justify-center align-center items-center text-white '>
                            ...
                            <div
                                className='w-[400px] h-[500px] bg-slate-900 rounded-xl flex flex-col justify-center gap-[20px] border-t-4 border-blue-400 '>
                                    ...
                                    <div className='mx-auto text-xl sm:text-2xl w-3/4'>
                                        ...
                                        <input value={email} onChange={(e) => {
                                            setEmail(e.target.value)
                                               ...
                                               className='w-full pl-1 h-[30px] text-lg rounded-md text-slate-800 bg-white focus:outline-none'></input>
                                    </div>
                                    <div className='mx-auto text-xl sm:text-2xl w-3/4'>
                                        ...
                                        <input value={password} onChange={(e) => {
                                            setPassword(e.target.value)
                                               ...
                                               className='w-full pl-1 h-[30px] text-lg rounded-md bg-white text-slate-800 focus:outline-none'></input>
                                    </div>
                                </div>
                                ...
                                <div className='mx-auto  text-lg sm:text-xl   w-full flex justify-center '>
                                    <button onClick={(e) => handleLogin(e)}
                                            className='font-Mont bg-blue-400 py-1 w-1/2 rounded-lg duration-700 hover:bg-blue-600'>Submit
                                    </button>
                                </div>
                                <div className='mx-auto  text-sm  '>
                                    <h1 className='font-Mont mt-[-10px] mb-[20px]'>Not a member yet? <span
                                        className='cursor-pointer text-blue-400 underline' onClick={(e) => {
                                        resetData();
                                        setPage("register")
                                    }}>Register</span></h1>
                                </div>
                    ...
                    <div className='w-screen h-screen bg-slate-800 text-white flex justify-center' onKeyDown={(e) => {
                        ...
                        <div className='auth-page flex w-screen justify-center align-center items-center text-white '>
                            ...
                            <div
                                    ...
                                    <div className='mx-auto text-xl sm:text-2xl w-3/4'>
                                        ...
                                        <input value={username} onChange={(e) => {
                                            setUsername(e.target.value)
                                               ...
                                               className='bg-white w-full pl-1 h-[30px] text-lg rounded-md text-slate-800 focus:outline-none'></input>
                                    </div>
                                    <div className='mx-auto text-xl sm:text-2xl w-3/4'>
                                        <h1 className='font-Poppins text-xl'>Email:</h1>
                                        <input value={email} onChange={(e) => {
                                ...
                                <div className='mx-auto  text-sm  '>
                                    <h1 className='font-Mont mt-[-10px] mb-[20px]'>Already a member? <span
                                        className='cursor-pointer text-blue-400 underline' onClick={(e) => {
                                        resetData();
                                        setPage("login")
                                    }}>Login</span></h1>
